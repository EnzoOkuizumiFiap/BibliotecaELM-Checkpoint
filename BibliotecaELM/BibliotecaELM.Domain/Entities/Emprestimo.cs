...
public class Emprestimo : BaseEntity
{
    ...
    public List<LivroEmprestimo> LivroEmprestimo { get; private set; }
    
    public Emprestimo(DateTime dataEmprestimo, DateTime dataDevolucao, Usuario usuario, List<LivroEmprestimo> livros)
    {
